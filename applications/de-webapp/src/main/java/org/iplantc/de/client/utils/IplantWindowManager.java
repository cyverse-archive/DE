/**
 * Sencha GXT 3.0.0 - Sencha for GWT Copyright(c) 2007-2012, Sencha, Inc. licensing@sencha.com
 * 
 ...
 * 
 * XXX JDS This class is a direct clone and own of the GXT 3 {@link WindowManager} class. Some instances
 * of window were changed to widget.
 */
public class IplantWindowManager implements HasRegisterHandlers<Widget>, HasUnregisterHandlers<Widget> {

    private static IplantWindowManager instance;
     ...
     */
    public static IplantWindowManager get() {
        if (instance == null)
            instance = new IplantWindowManager();
        return instance;
    }

    private final AccessStack<Widget> accessList;
    ...
    /**
     * Brings the specified widget to the front of any other active widgets. {@link Window} instances
     * will automatically call this method when focused, all other types must call manually.
     * 
     * @param widget the window
     * @return true if the widget was brought to the front, else false if it was already in front
     */
    ...
    /**
     * Registers the window with the WindowManager. {@link Window} instances will automatically register
     * and unregister themselves. All other types must register / unregister manually.
     * 
     * @param widget the window
     */
