...
class UserSessionProgressMessageBox extends AutoProgressMessageBox implements IsHideable {
    ...
    public static UserSessionProgressMessageBox saveSession(NewDesktopView.Presenter presenter) {
        return saveSession(presenter, null);
    }

    public static UserSessionProgressMessageBox saveSession(NewDesktopView.Presenter presenter, String redirectUrl) {
    ...
    public static UserSessionProgressMessageBox restoreSession(NewDesktopView.Presenter presenter) {
    ...
    private UserSessionProgressMessageBox(String headingHtml, String messageHtml,
                                          ProgressBoxType type, NewDesktopView.Presenter presenter) {
    ...
    private final class GetUserSessionCallback implements AsyncCallback<String> {
        ...
        public GetUserSessionCallback(IsHideable msgBox, NewDesktopView.Presenter presenter, UserSessionFactory factory) {
            this.msgBox = msgBox;
            this.presenter = presenter;
