...
public class TestNameListLoaderSingleColumn {
    ...
    public static void beforeClass() throws Exception {
        ...
        // csvFile = new File(new
        // TestNameListLoaderSingleColumn().getClass().getResource("/SingleColumnWorkbook.csv").toURI());
        // optimus = new NameListTransformer();
        // ptd = new PersistTreeData();
        //
        // data = csvParser.parse(csvFile);
        // truck = optimus.transform(data, "SingleColumnWorkbook.csv");
        //
