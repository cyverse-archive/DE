...
public class StringTag extends Tag<String> {
    public static TagCreationCodex<StringTag> tagCreationCodex = new TagCreationCodex<StringTag>() {
        @Override
    ...
    public StringTag( String caption ) {
        super( caption, caption );
    }

    public StringTag( String caption, String value ) {
        super( caption, value );
    }
}
