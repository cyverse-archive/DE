...
public class ToolTestDataOutputFilesListEditor extends Composite
    ...
    public ToolTestDataOutputFilesListEditor() {
        ...
        ColumnConfig<String, String> outputFile =
                new ColumnConfig<String, String>(getValueProvider(), appearance.toolTestDataOutputFilesWidth(), appearance.toolTestDataOutputFilesLabel());
    ...
    public List<String> getTestDataOutputFilesList() {
