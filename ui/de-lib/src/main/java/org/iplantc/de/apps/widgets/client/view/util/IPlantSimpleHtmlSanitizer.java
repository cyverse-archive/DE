 ...
 * 
 * <ul>
 * <li>{@code <p>}, {@code <br>}, {@code <b>}, {@code <em>}, {@code <i>}</li>
 ...
 */
public final class IPlantSimpleHtmlSanitizer implements HtmlSanitizer {

    private static final IPlantSimpleHtmlSanitizer INSTANCE = new IPlantSimpleHtmlSanitizer();

    private static final Set<String> TAG_WHITELIST = new HashSet<String>(Arrays.asList("p", "br", "b", "em", "i", "h1", "h2", "h3", "h4", "h5", "h6", "hr", "ul", "ol", "li"));
     ...
     * @return the instance
     */
    public static IPlantSimpleHtmlSanitizer getInstance() {
        return INSTANCE;
    }
     ...
     * 
     * <p>
     * The input string is processed as described above. The result of sanitizing the string is
    ...
    private IPlantSimpleHtmlSanitizer() {}
