...
/*BySubjectAndResource swagger:route GET /transitive_permissions/subjects/{subject_type}/{subject_id}/{resource_type}/{resource_name} permission_lookup bySubjectAndResource
