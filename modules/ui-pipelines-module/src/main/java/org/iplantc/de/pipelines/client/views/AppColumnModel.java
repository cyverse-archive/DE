...
public class AppColumnModel extends ColumnModel<PipelineTask> {
    ...
    public static List<ColumnConfig<PipelineTask, ?>> createColumnConfigList(PipelineAppProperties props) {
        ColumnConfig<PipelineTask, Integer> step = new ColumnConfig<PipelineTask, Integer>(props.step(),
        ...
        ColumnConfig<PipelineTask, String> description = new ColumnConfig<PipelineTask, String>(
