...
public class ArgumentGroupEditorAppEditorImpl extends ArgumentGroupEditorImpl {
    ...
    @Inject
    public ArgumentGroupEditorAppEditorImpl(ArgumentGroupContentPanelAppearance cpAppearance, AppTemplateWizardAppearance appearance, Provider<AppTemplateForm.ArgumentEditorFactory> argumentEditorProvider) {
