...
public class ReferenceSequenceEditor extends AbstractArgumentEditor implements HasValueChangeHandlers<Splittable> {
    private final ComboBox<ReferenceGenome> comboBox;
    private final ArgumentEditorConverter<ReferenceGenome> editorAdapter;

    public ReferenceSequenceEditor(AppTemplateWizardAppearance appearance, ListStore<ReferenceGenome> refGenomeStore, ReferenceGenomeProperties props) {
        super(appearance);
