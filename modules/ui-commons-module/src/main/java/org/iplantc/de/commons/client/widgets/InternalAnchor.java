...
public final class InternalAnchor<T> extends InlineHTML implements HasOpenHandlers<T> {
     ...
     */
    public InternalAnchor(final T target,
                          final String text) {
    ...
    private InternalAnchor(final T target,
    ...
    public static <T> InternalAnchor<T> wrap(final T target, final XElement element) {
        final InternalAnchor<T> anchor = new InternalAnchor<>(target, element);
    ...
    protected final void initClickHandler() {
