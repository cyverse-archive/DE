...
(defn- add-ezid-request-tables
  ...
  (load-sql-file "tables/77_permanent_id_requests.sql")
  ...
  (load-sql-file "constraints/00_77_permanent_id_requests_pkey.sql")
  (load-sql-file "constraints/77_permanent_id_requests.sql")

  (println "\t* Adding permanent_id_request_statuses constraints...")
  (load-sql-file "constraints/00_78_permanent_id_request_statuses_pkey.sql")
  (load-sql-file "constraints/78_permanent_id_request_statuses.sql")
